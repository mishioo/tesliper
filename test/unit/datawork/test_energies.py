...
class TestCalculateDeltas(ut.TestCase):
    ...
    def test_more_values(self):
        ...
        self.assertSequenceEqual(out.tolist(), [0, 0.6275095, 2 * 0.6275095])
...
class TestCalculateMinFactor(ut.TestCase):
    ...
    def test_more_values(self, deltas):
        deltas.return_value = np.array([0, 0.6275095, 2 * 0.6275095])
...
class TestCalculatePopulations(ut.TestCase):
    ...
    def test_more_values(self, factors):
        ...
        self.assertSequenceEqual(
            np.round(out, decimals=8).tolist(), [0.68166002, 0.23637423, 0.08196575]
        )
    ...
    def test_other_temp(self, factors):
        ...
        self.assertSequenceEqual(
            np.round(out, decimals=8).tolist(), [0.8008148, 0.16513353, 0.03405167]
        )
